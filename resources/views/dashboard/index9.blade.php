                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div class="col-span-12 md:col-span-4">
                            <div class="trail-bg h-full text-center flex flex-col justify-between items-center p-4 rounded-lg bg-cover bg-no-repeat bg-center" style="background-image: url('{{ asset('assets/images/home-nine/trail-bg.png') }}');">
                                <h6 class="text-white text-xl">Clinic Performance Snapshot</h6>
                                <div class="">
                                    <p class="text-white mb-2">Lead-to-visit conversion up 3% this week</p>
                                    <a href="#" class="btn py-2 rounded-[50rem] w-full bg-gradient-to-r from-[#CBFFF9] to-[#FFEEB1] text-sm justify-center dark:text-neutral-900 hover:scale-[1.06]">View Insights</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-12 gap-4">
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="rounded-lg h-full text-center p-5 bg-purple-light">
                                        ...
                                        <span class="text-neutral-700 block">Collections</span>
                                        <h6 class="mb-0 mt-1">$84,500.09</h6>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="rounded-lg h-full text-center p-5 bg-success-100 dark:bg-success-600/10">
                                        ...
                                        <span class="text-neutral-700 block">Treatments Completed</span>
                                        <h6 class="mb-0 mt-1">186</h6>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="rounded-lg h-full text-center p-5 bg-info-focus">
                                        ...
                                        <span class="text-neutral-700 block">Qualified Leads</span>
                                        <h6 class="mb-0 mt-1">420</h6>
                                    </div>
                                </div>
                                <div class="col-span-12 sm:col-span-6">
                                    <div class="rounded-lg h-full text-center p-5 bg-danger-100 dark:bg-danger-600/10">
                                        ...
                                        <span class="text-neutral-700 block">No Shows</span>
                                        <h6 class="mb-0 mt-1">18</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    <div class="flex items-center flex-wrap gap-2 justify-between">
                        <h6 class="font-bold text-lg mb-0">Clinic Revenue</h6>
                    ...
                    <ul class="flex flex-wrap items-center justify-center my-3 gap-6">
                        <li class="flex flex-col gap-1">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-neutral-600 text-sm font-semibold">Collections</span>
                            </div>
                            <div class="flex items-center gap-2">
                        ...
                        <li class="flex flex-col gap-1">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-neutral-600 text-sm font-semibold">Outstanding</span>
                            </div>
                            <div class="flex items-center gap-2">
        ...
        <div class="col-span-12 2xl:col-span-6">
            <div class="card h-full border-0">
                <div class="card-header border-bottom-0 pb-3 flex items-center flex-wrap gap-2 justify-between">
                    <h6 class="font-bold text-lg mb-0">Lead Source Performance</h6>
                    <select class="form-select form-select-sm w-auto bg-base border text-neutral-600 dark:text-white dark:bg-neutral-800">
                ...
                <div class="card-body">
                    <div class="relative h-full min-h-[320px]">
                        <div class="md:absolute start-0 top-0 mt-5">
                            <h6 class="mb-1">1,248</h6>
                            <span class="text-neutral-600">Total Leads</span>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-4 min-h-[inherit]">
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
                                <div class="flex flex-col items-center p-6 pt-4 rounded-t-xl bg-gradient-to-b from-[#ffba4540] to-[#f4743540]" style="min-height: 50%;">
                                    ...
                                    <span class="text-neutral-600">WhatsApp</span>
                                    <h6 class="mb-0">28%</h6>
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-3 sm:col-span-6 flex flex-col justify-end">
            ...
            <div class="card h-full border-0">
                <div class="card-body p-6">
                    <div class="flex align-items-start flex-col gap-2">
                        <h6 class="mb-2 font-bold text-lg">Lead Stage Movement</h6>
                        <span class="text-neutral-600">Weekly pipeline movement</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-[22px] mt-8">
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">New Leads</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">248</span>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">Qualified</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">162</span>
                                <span class="text-danger-600 text-base font-medium">-4%</span>
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">Booked</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">96</span>
                                <span class="text-success-600 text-base font-medium">0.3%</span>
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">Treatment Started</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">44</span>
                                <span class="text-success-600 text-base font-medium">0.3%</span>
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">Completed</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">28</span>
                                <span class="text-success-600 text-base font-medium">0.3%</span>
                            </div>
                        </div>
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="text-base mb-0 font-semibold">Payment Completed</h6>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span class="text-neutral-600 text-base font-medium">24</span>
                                <span class="text-success-600 text-base font-medium">0.3%</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-span-12 2xl:col-span-8">
            <div class="card h-full border-0">
                <div class="card-header border-bottom bg-base py-4 px-6 flex items-center justify-between">
                    <h6 class="text-lg font-semibold mb-0">Recent Payments</h6>
                    <a href="javascript:void(0)" class="text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1">
                        View All
                        <iconify-icon icon="solar:alt-arrow-right-linear" class="icon"></iconify-icon>
                    </a>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive scroll-sm">
                        <table class="table bordered-table mb-0 rounded-0 border-0">
                            <thead>
                                <tr>
                                    <th scope="col" class="bg-transparent rounded-0 !py-5">Patient</th>
                                    <th scope="col" class="bg-transparent rounded-0 !py-5">Invoice</th>
                                    <th scope="col" class="bg-transparent rounded-0 !py-5">Paid At</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>5 min ago</td>
                                    <td>$12,408.12</td>
                                    <td> <span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Paid</span> </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
                                    ...
                                    <td>12 min ago</td>
                                    <td>$12,408.12</td>
                                    <td> <span class="bg-purple-100 dark:bg-purple-600/20 text-purple-600 dark:text-purple-600 px-2.5 py-1 rounded-lg font-medium text-sm">Partial</span> </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="flex items-center">
