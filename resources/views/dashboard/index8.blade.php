                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-6">
                            ...
                            <div class="card-body p-0">
                                <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <h6 class="font-semibold mb-0.5">24</h6>
                                            <span class="font-medium text-gray-600 text-sm">Doctors</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-sm mb-0 text-gray-600"><span class="text-cyan-600 dark:text-cyan-600">3</span> consult slots open</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                            ...
                            <div class="card-body p-0">
                                <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <h6 class="font-semibold mb-0.5">8</h6>
                                            <span class="font-medium text-gray-600 text-sm">CSR / Reception</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-sm mb-0 text-gray-600"><span class="text-lilac-600 dark:text-lilac-600">18</span> follow-ups pending</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                            ...
                            <div class="card-body p-0">
                                <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <h6 class="font-semibold mb-0.5">1,245</h6>
                                            <span class="font-medium text-gray-600 text-sm">Patients</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-sm mb-0 text-gray-600"><span class="text-primary-600 dark:text-primary-600">42</span> new leads qualified</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 2xl:col-span-3">
                            ...
                            <div class="card-body p-0">
                                <div class="flex flex-wrap items-center justify-between gap-1 mb-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div>
                                            <h6 class="font-semibold mb-0.5">36</h6>
                                            <span class="font-medium text-gray-600 text-sm">Treatment Sessions</span>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-sm mb-0 text-gray-600"><span class="text-success-600 dark:text-success-600">12</span> sessions today</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-0 h-full">
                            <div class="card-header">
                                <div class="flex items-center gap-2 justify-between">
                                    <h6 class="mb-0 font-bold text-lg">Treatment Outcomes</h6>
                    ...
                    <div class="col-span-12 lg:col-span-6">
                        <div class="card border-0 h-full">
                            <div class="card-header">
                                <div class="flex items-center gap-2 justify-between">
                                    <h6 class="mb-0 font-bold text-lg">Treatment Mix</h6>
                                </div>
                            </div>
                            <div class="card-body p-1.5 flex items-center gap-4">
                                ...
                                <ul class="flex flex-col gap-3">
                                    <li>
                                        <span class="text-lg">HydraFacial: <span class="text-primary-600 dark:text-primary-600 font-semibold">48%</span> </span>
                                    </li>
                                    <li>
                                        <span class="text-lg">Laser: <span class="text-warning-600 dark:text-warning-600 font-semibold">32%</span> </span>
                                    </li>
                                    <li>
                                        <span class="text-lg">PRP: <span class="text-success-600 dark:text-success-600 font-semibold">20%</span> </span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-span-12 2xl:col-span-4">
                        <div class="card border-0">
                            <div class="card-header border-bottom">
                                <div class="flex items-center gap-2 justify-between">
                                    <h6 class="mb-0 font-bold text-lg">Doctor Schedule</h6>
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">HydraFacial</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">Laser</span>
                                            </div>
                                        </div>
                                        <span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Available</span>
                                    </div>
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">PRP</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">Dermal Fillers</span>
                                            </div>
                                        </div>
                                        <span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Available</span>
                                    </div>
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">Cryolipolysis</span>
                                            </div>
                                        </div>
                                        <span class="bg-danger-focus text-danger-main dark:text-danger-main px-2.5 py-1 rounded-lg font-medium text-sm">Not Available</span>
                                    </div>
                                    <div class="flex items-center justify-between gap-3">
                                        <div class="flex items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-sm text-gray-600 font-medium">Skin Analysis</span>
                                            </div>
                                        </div>
                                        <span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Available</span>
                                    </div>
                    ...
                    <div class="col-span-12 2xl:col-span-8">
                        <div class="card border-0 h-full">
                            <div class="card-header border-bottom bg-base py-4 px-6 flex items-center justify-between">
                                <h6 class="text-lg font-semibold mb-0">Consultations Today</h6>
                                <a href="javascript:void(0)" class="flex-shrink-0 text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1">
                                    View All
                                    <iconify-icon icon="solar:alt-arrow-right-linear" class="icon"></iconify-icon>
                                </a>
                                    ...
                                    <table class="table bordered-table mb-0 rounded-0 border-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>#A-1210</td>
                                                <td>10:45 AM</td>
                                                <td><span class="bg-warning-focus text-warning-main dark:text-warning-main px-2.5 py-1 rounded-lg font-medium text-sm">Rescheduled</span></td>
                                            </tr>
                                            <tr>
                                                <td>PRP Assessment</td>
                                                <td>#A-1216</td>
                                                <td>11:30 AM</td>
                                                <td><span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Completed</span></td>
                                            </tr>
                                            <tr>
                                                <td>Dermal Fillers Plan</td>
                                                <td>#A-1222</td>
                                                <td>01:00 PM</td>
                                                <td><span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Confirmed</span></td>
                                            </tr>
                                            <tr>
                                                <td>Fat Dissolving Review</td>
                                                <td>#A-1230</td>
                                                <td>02:15 PM</td>
                                                <td><span class="bg-warning-focus text-warning-main dark:text-warning-main px-2.5 py-1 rounded-lg font-medium text-sm">Pending</span></td>
                                            </tr>
                                            <tr>
                                                <td>Skin Analysis Follow-up</td>
                                                <td>#A-1236</td>
                                                <td>03:40 PM</td>
                                                <td><span class="bg-danger-focus text-danger-main dark:text-danger-main px-2.5 py-1 rounded-lg font-medium text-sm">No Show</span></td>
                                            </tr>
                                            <tr>
                                                <td>Laser Consultation</td>
                                                <td>#A-1241</td>
                                                <td>05:00 PM</td>
                                                <td><span class="bg-success-focus text-success-main dark:text-success-main px-2.5 py-1 rounded-lg font-medium text-sm">Completed</span></td>
                                            </tr>
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div class="col-span-12 2xl:col-span-6 md:col-span-6 3xl:col-span-12">
                        <div class="card border-0">
                            <div class="card-header">
                                <div class="flex items-center gap-2 justify-between">
                                    <h6 class="mb-0 font-bold text-lg">Treatment Worksheets</h6>
                                    <a href="javascript:void(0)" class="flex-shrink-0 text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1">
                                        View All
                                        <iconify-icon icon="solar:alt-arrow-right-linear" class="icon"></iconify-icon>
                                    </a>
                            ...
                            <div class="card-body">
                                <div class="flex items-center justify-between gap-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">HydraFacial</h6>
                                            <span class="text-sm text-gray-600 font-normal">6 sessions</span>
                                        </div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between gap-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">Laser</h6>
                                            <span class="text-sm text-gray-600 font-normal">9 sessions</span>
                                        </div>
                                    </div>
                                    <span class="text-gray-600">08:45 AM</span>
                                </div>
                                <div class="flex items-center justify-between gap-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">PRP</h6>
                                            <span class="text-sm text-gray-600 font-normal">4 sessions</span>
                                        </div>
                                    </div>
                                    <span class="text-gray-600">08:45 AM</span>
                                </div>
                                <div class="flex items-center justify-between gap-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">Dermal Fillers</h6>
                                            <span class="text-sm text-gray-600 font-normal">3 sessions</span>
                                        </div>
                                    </div>
                                    <span class="text-gray-600">08:45 AM</span>
                                </div>
                                <div class="flex items-center justify-between gap-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">Fat Dissolving</h6>
                                            <span class="text-sm text-gray-600 font-normal">5 sessions</span>
                                        </div>
                                    </div>
                                    <span class="text-gray-600">08:45 AM</span>
                                </div>
                                <div class="flex items-center justify-between gap-3 mb-0">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="text-base mb-0 font-normal">Cryolipolysis</h6>
                                            <span class="text-sm text-gray-600 font-normal">2 sessions</span>
                                        </div>
                                    </div>
                                    <span class="text-gray-600">08:45 AM</span>
                                </div>
                    ...
                    <div class="col-span-12 2xl:col-span-6 md:col-span-6 3xl:col-span-12">
                        <div class="card border-0">
                            <div class="card-header">
                                <div class="flex items-center gap-2 justify-between">
                                    <h6 class="mb-0 font-bold text-lg line-clamp-1">Treatment Evidence</h6>
                                    <a href="javascript:void(0)" class="flex-shrink-0 text-primary-600 dark:text-primary-600 hover-text-primary flex items-center gap-1">
                                        View All
                                        <iconify-icon icon="solar:alt-arrow-right-linear" class="icon"></iconify-icon>
                                    </a>
