  ...
  createChart('new-user-chart', '#f59e0b');
  createChart('active-user-chart', '#16a34a');
  createChart('total-sales-chart', '#2563eb');
  createChart('conversion-user-chart', '#111827');
  createChart('leads-chart', '#e11d48');
  createChart('total-profit-chart', '#0284c7');
  ...
  // ================================ Earning Statistics bar chart Start ================================ 
    ...
    var barChartElement = document.querySelector("#barChart");
    if (barChartElement) {
  ...
  // ================================ Custom Overview Donut chart Start ================================ 
    var options = { 
      ...
      labels: ['Skin Treatment', 'Hair Treatment', 'Botox & Aesthetics'],
      legend: {
          show: false 
      },
      chart: {
    ...
    var donutChartElement = document.querySelector("#donutChart");
    if (donutChartElement) {
      var chart = new ApexCharts(donutChartElement, options);
      chart.render();
    }
  ...
  // ================================ Client Payment Status chart End ================================ 
    var options = {
      ...
      labels: ['Booked', 'Rescheduled', 'No-show'],
    ...
    var paymentStatusElement = document.querySelector("#paymentStatusChart");
    if (paymentStatusElement) {
      var chart = new ApexCharts(paymentStatusElement, options);
      chart.render();
    }
  // ================================ Client Payment Status chart End ================================ 
